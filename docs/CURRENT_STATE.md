...
- Current release is `Rbc7f35feb1d2dc29`, pairing base commit `uhdpedb4pr97ve80aq6nrabr66atsqtq` with supplemental commit `2tgo2jga66uejt70sau2qcpusc8r1k8t`. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
...
- G2 market status worker has completed 56 tasks, satisfied 34 already-published tasks without repeat download, and quarantined 20 confirmed BaoStock source limitations; 5,439 release-audited checks remain pending. The exact evidence is in [G2 progress](acceptance/datahub-v4/g2-market-status-progress.md).
