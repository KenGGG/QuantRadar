...
- Current release is `Rbe776ee098dcec6b`, pairing base commit `0o6tgnmq5vabt3orqrk8rhqptniae26l` with supplemental commit `vvnlfpgb25uljcl8lv1gqcfnj16lr0dt`. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
...
- The dedicated status maintenance service completed an end-to-end user-timer catch-up on 2026-09-15, verified base commit `0o6tgnmq5vabt3orqrk8rhqptniae26l`, refreshed the 5,899-security master, and published `R91ec6235708e3d10` without starting legacy valuation collection. A follow-up fixed the paired-release alignment and recorded base-only release `Rbe776ee098dcec6b` before its status Worker began.
