...
- Current release is `Rc02b494fe397bcac`, pairing base commit `uhdpedb4pr97ve80aq6nrabr66atsqtq` with supplemental commit `oa4im51n4ir5vqek3308245pbpheugjh`. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
...
- G2 market status worker has completed 11 tasks and quarantined 3 confirmed BaoStock source limitations; 5,535 release-audited checks remain pending. The exact evidence is in [G2 progress](acceptance/datahub-v4/g2-market-status-progress.md).
