...
- `quantradar-datahub.timer` is installed and active. It triggers the DataHub daily coordinator at 20:00 Asia/Shanghai; the coordinator handles the current 20-trading-day status correction window and 50 persisted historical status tasks per run.
