...
- Current release is `R3f2a0c82acf28962`, pairing the fixed base commit with supplemental commit `vebg16rsbuq8qke13j7ctgta23oqojs7`: 5,235 valuation securities / 9,206,992 rows through 2026-09-11. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
- The current release also has 43 published BaoStock trade-status patch records for 23 securities on 2023-08-31 and 2023-09-01. They fill verified base gaps only and remain PIT_PARTIAL. The 2023-08-31 low-Beta first-rebalance repair is independently recorded in `acceptance/datahub-v2-p3/low-beta-2023-08-31-repair.md`; later monthly status dates are still unresolved.
