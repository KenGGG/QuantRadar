...
- Current release is `R77e0dde27449d342`, pairing base commit `0o6tgnmq5vabt3orqrk8rhqptniae26l` with supplemental commit `id9v6i459efka9l102lrt018uj9rbg39`. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
...
- G2 market status worker has completed 180 tasks, satisfied 34 already-published tasks without repeat download, and quarantined 45 confirmed BaoStock source limitations; 5,290 historical checks and 5,551 current-window checks remain pending. The fixed-release 20-trading-day audit found 17,764 valid of 208,552 lifecycle-qualified status fields; the exact evidence is in [G2 progress](acceptance/datahub-v4/g2-market-status-progress.md).
