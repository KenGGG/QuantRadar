...
- Current release is `Ra3aa859825d6c140`, pairing base commit `uhdpedb4pr97ve80aq6nrabr66atsqtq` with supplemental commit `j1sqlsc000tsfmposh27ed8o1n5v7egc`. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
