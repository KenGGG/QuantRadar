...
- Current release is `Rb7a2cd281c8e2ebe`, pairing base commit `0o6tgnmq5vabt3orqrk8rhqptniae26l` with supplemental commit `e65blig93qrt9br7dskcp3oscrcmprhb`. The valuation failure baseline remains 196 parsing failures plus 123 unverified-coverage records; no failed security was silently reclassified or deleted.
...
- G2 market status worker has completed 64 tasks, satisfied 34 already-published tasks without repeat download, and quarantined 23 confirmed BaoStock source limitations; 5,428 release-audited checks remain pending. The exact evidence is in [G2 progress](acceptance/datahub-v4/g2-market-status-progress.md).
