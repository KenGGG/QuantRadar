...
- The reviewed `quantradar-datahub.service` and `quantradar-datahub.timer` were installed and enabled on 2026-09-15. The active timer invokes the daily coordinator at 20:00 Asia/Shanghai with an infinite service start timeout; it runs the 20-trading-day current window and one 50-task historical batch.
