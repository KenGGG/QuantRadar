...
批次 `780c4ea0-d8b1-4b65-bbc6-84b94dd11659` 再次固定在同一 release，使用
“显式成员 ∩ 发布版生命周期有效区间”构造日度 `universe`，没有以价格非空性
缩小截面。结果仍为 #1/#56 `COMPUTED`、#58 `BLOCKED_INPUT(indclass.sector)`、
批次 `PARTIAL_SUCCESS`。
