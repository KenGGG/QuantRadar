...
export interface ETFGroup extends ExperimentResp { config?: { items?: Array<{ template: string; status: string; run_id?: string; error?: string; preflight?: { missing?: Array<Record<string,string>> } }>; [key: string]: unknown; }; }
